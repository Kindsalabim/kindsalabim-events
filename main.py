...
def run_migrations():
    ...
    add_column("events", "privatkunde", "BOOLEAN DEFAULT 0")
    add_column("events", "cl_rechnung_email", "VARCHAR")
    add_column("events", "cl_anlieferung_vortag", "BOOLEAN DEFAULT 0")
    add_column("events", "cl_anlieferung_von", "VARCHAR")
    add_column("events", "cl_anlieferung_bis", "VARCHAR")
    add_column("events", "cl_abholung_folgetag", "BOOLEAN DEFAULT 0")
    add_column("events", "cl_abholung_von", "VARCHAR")
    add_column("events", "cl_abholung_bis", "VARCHAR")
    add_column("events", "cl_aufbau_bedingungen", "TEXT")
    add_column("events", "cl_rechnung_firma", "VARCHAR")
    add_column("events", "cl_rechnung_strasse", "VARCHAR")
    add_column("events", "cl_rechnung_plz_ort", "VARCHAR")
    add_column("events", "vorkasse_erinnert", "BOOLEAN DEFAULT 0")
    add_column("events", "rechnung_mail_erinnert", "BOOLEAN DEFAULT 0")
    add_column("kunden", "rechnung_email", "VARCHAR")
